...
echo -e "name\tgene_model_type\tshort_description" > tair10_gene_anno.tsv
cat TAIR10_functional_descriptions_20140331.txt|grep '^AT[0-9]G'|cut -f1-3|sed -r 's/\.[0-9]+\t/\t/'|sort|uniq > tmp
